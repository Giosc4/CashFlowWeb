...
$insertRisparmioQuery =  "INSERT INTO risparmi (ImportoRisparmiato, DataInizio, DataFine, IDConto, IDCategoriaPrimaria) VALUES (?, ?, ?, ?, ?)";
$insertDebitQuery = "INSERT INTO debit (ImportoDebito, NomeImporto, DataConcessione, DataEstinsione, Note, IDConto, IDCategoriaPrimaria) VALUES (?, ?, ?, ?, ?, ?, ?)";
$insertCreditQuery = "INSERT INTO credit (ImportoCredito, NomeImporto, DataConcessione, DataEstinsione, Note, IDConto, IDCategoriaPrimaria) VALUES (?, ?, ?, ?, ?, ?, ?)";
