<?php
$insertTransactionQuery = "INSERT INTO `transazione` (Entrata_Uscita, Importo, IDConto, DataTransazione, IDCategoriaPrimaria, IDCategoriaSecondaria,  Descrizione) VALUES (?, ?, ?, ?, ?, ?, ?)";
