    ...
    IF Days > 0 THEN
        ...
        IF (SELECT Saldo FROM conto WHERE ID = AccountID) >= DailyAmount THEN
            ...
            IF CURDATE() BETWEEN StartDate AND EndDate THEN
                ...
                VALUES (1, DailyAmount, AccountID, CURDATE(), PrimaryCategoryID, NULL);
            END IF;
        END IF;
    END IF;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `CreateTransactionFromTemplate` (IN `TemplateID` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_transaction_on_credit_termination` (IN `creditID` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_transaction_on_debit_termination` (IN `debitID` INT)   BEGIN
    DECLARE currentDate DATE;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteBudget` (IN `p_ID` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteCredito` (IN `p_ID` INT)   BEGIN
    DELETE FROM credit
    WHERE ID = p_ID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteDebito` (IN `p_ID` INT)   BEGIN
    DELETE FROM debit
    WHERE ID = p_ID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `DeletePrimaryCategory` (IN `p_ID` INT)   BEGIN
    DELETE FROM categoriaprimaria
    WHERE ID = p_ID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteRisparmio` (IN `p_ID` INT)   BEGIN
    DELETE FROM risparmi
    WHERE ID = p_ID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteSecondaryCategory` (IN `p_ID` INT)   BEGIN
    DELETE FROM categoriasecondaria
    WHERE ID = p_ID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteTemplateTransaction` (IN `p_ID` INT)   BEGIN
    DELETE FROM template_transazioni
    WHERE ID = p_ID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteTransaction` (IN `p_ID` INT)   BEGIN
    DELETE FROM transazione
    WHERE ID = p_ID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GenerateFinancialReport` (IN `startDate` DATE, IN `endDate` DATE, IN `transactionType` TINYINT, IN `accountId` INT, IN `primaryCategoryId` INT, IN `secondaryCategoryId` INT)   BEGIN
    SELECT 
        t.ID,
        t.Is_Expense,
        t.Importo,
    ...
    WHERE 
        ...
        AND (primaryCategoryId IS NULL OR t.IDCategoriaPrimaria = primaryCategoryId)
        AND (secondaryCategoryId IS NULL OR t.IDCategoriaSecondaria = secondaryCategoryId);
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllCategorieSecondarie` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllTransazioniTemplate` ()   BEGIN
    SELECT * FROM `template_transazioni`;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetBudgetByEmail` (IN `email` VARCHAR(255))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCategoriaPrimariaByEmail` (IN `email` VARCHAR(255))   BEGIN
    SELECT categoriaprimaria.* FROM categoriaprimaria
    JOIN profili_categoriaprimaria ON categoriaprimaria.ID = profili_categoriaprimaria.IDCategoriaPrimaria
    JOIN profili ON profili_categoriaprimaria.IDProfilo = profili.ID
    WHERE profili.Email = email;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCategoriaSecondariaByEmail` (IN `email` VARCHAR(255))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetContoByEmail` (IN `email` VARCHAR(255))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCreditiByEmail` (IN `email` VARCHAR(255))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetDebitiByEmail` (IN `email` VARCHAR(255))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetRisparmiByEmail` (IN `email` VARCHAR(255))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetTransazioniByEmail` (IN `email` VARCHAR(255))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetTransazioniTemplateByEmail` (IN `email` VARCHAR(255))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertBudget` (IN `_NomeBudget` VARCHAR(255), IN `_ImportoMax` DECIMAL(10,2), IN `_DataInizio` DATE, IN `_DataFine` DATE, IN `_IDPrimaryCategory` INT)   BEGIN
    INSERT INTO budgetmax (NomeBudget, ImportoMax, DataInizio, DataFine, IDPrimaryCategory)
    VALUES (_NomeBudget, _ImportoMax, _DataInizio, _DataFine, _IDPrimaryCategory);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertConto` (IN `_NomeConto` VARCHAR(255), IN `_Saldo` DECIMAL(10,2), IN `_IDProfilo` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertCredit` (IN `_ImportoCredito` DECIMAL(10,2), IN `_NomeImporto` VARCHAR(255), IN `_DataConcessione` DATE, IN `_DataEstinsione` DATE, IN `_Note` TEXT, IN `_IDConto` INT, IN `_IDCategoriaPrimaria` INT)   BEGIN
    INSERT INTO credit (ImportoCredito, NomeImporto, DataConcessione, DataEstinsione, Note, IDConto, IDCategoriaPrimaria)
    VALUES (_ImportoCredito, _NomeImporto, _DataConcessione, _DataEstinsione, _Note, _IDConto, _IDCategoriaPrimaria);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertDebt` (IN `_ImportoDebito` DECIMAL(10,2), IN `_NomeImporto` VARCHAR(255), IN `_DataConcessione` DATE, IN `_DataEstinsione` DATE, IN `_Note` TEXT, IN `_IDConto` INT, IN `_IDCategoriaPrimaria` INT)   BEGIN
    INSERT INTO debit (ImportoDebito, NomeImporto, DataConcessione, DataEstinsione, Note, IDConto, IDCategoriaPrimaria) VALUES (_ImportoDebito, _NomeImporto, _DataConcessione, _DataEstinsione, _Note, _IDConto, _IDCategoriaPrimaria);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `insertPrimaryCategory` (IN `_NomeCategoria` VARCHAR(255), IN `_DescrizioneCategoria` TEXT, IN `_IDProfilo` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertProfile` (IN `_NomeProfilo` VARCHAR(255), IN `_Email` VARCHAR(255), IN `_Password` VARCHAR(255))   BEGIN
    INSERT INTO Profili (NomeProfilo, Email, Password)
    VALUES (_NomeProfilo, _Email, _Password);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertSavings` (IN `_ImportoRisparmiato` DECIMAL(10,2), IN `_DataInizio` DATE, IN `_DataFine` DATE, IN `_IDConto` INT, IN `_IDCategoriaPrimaria` INT)   BEGIN
    INSERT INTO risparmi (ImportoRisparmiato, DataInizio, DataFine, IDConto, IDCategoriaPrimaria) VALUES (_ImportoRisparmiato, _DataInizio, _DataFine, _IDConto, _IDCategoriaPrimaria);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertSecondaryCategory` (IN `_IDCategoriaPrimaria` INT, IN `_NomeCategoria` VARCHAR(255), IN `_DescrizioneCategoria` TEXT)   BEGIN
    INSERT INTO `categoriasecondaria` (IDCategoriaPrimaria, NomeCategoria, DescrizioneCategoria) VALUES (_IDCategoriaPrimaria, _NomeCategoria, _DescrizioneCategoria);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertTransaction` (IN `_Is_Expense` BOOLEAN, IN `_Importo` DECIMAL(10,2), IN `_IDConto` INT, IN `_DataTransazione` DATE, IN `_IDCategoriaPrimaria` INT, IN `_IDCategoriaSecondaria` INT)   BEGIN
    INSERT INTO transazione (Is_Expense, Importo, IDConto, DataTransazione, IDCategoriaPrimaria, IDCategoriaSecondaria) VALUES (_Is_Expense, _Importo, _IDConto, _DataTransazione, _IDCategoriaPrimaria, _IDCategoriaSecondaria);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertTransactionTemplate` (IN `_NomeTemplate` VARCHAR(255), IN `_Is_Expense` BOOLEAN, IN `_Importo` DECIMAL(10,2), IN `_IDConto` INT, IN `_IDCategoriaPrimaria` INT, IN `_IDCategoriaSecondaria` INT, IN `_Descrizione` TEXT)   BEGIN
    INSERT INTO template_transazioni (NomeTemplate, Is_Expense, Importo, IDConto, IDCategoriaPrimaria, IDCategoriaSecondaria, Descrizione)
    VALUES (_NomeTemplate, _Is_Expense, _Importo, _IDConto, _IDCategoriaPrimaria, _IDCategoriaSecondaria, _Descrizione);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectAccountById` (IN `accountID` INT)   BEGIN
    SELECT * FROM conto WHERE ID = accountID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectBudgetFromID` (IN `budgetID` INT)   BEGIN
    SELECT * FROM budgetmax WHERE ID = budgetID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectCategoriaPrimariaById` (IN `primaryID` INT)   BEGIN
    SELECT * FROM categoriaprimaria WHERE ID = primaryID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectCreditFromID` (IN `creditID` INT)   BEGIN
    SELECT * FROM credit WHERE ID = creditID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectDebitFromID` (IN `debitID` INT)   BEGIN
    SELECT * FROM debit WHERE ID = debitID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectIdContoFromNome` (IN `accountName` VARCHAR(255))   BEGIN
    SELECT ID FROM conto WHERE NomeConto = accountName;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectIDProfileByEmail` (IN `userEmail` VARCHAR(255))   BEGIN
    SELECT ID FROM Profili WHERE Email = userEmail;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectSavingFromID` (IN `savingID` INT)   BEGIN
    SELECT * FROM risparmi WHERE ID = savingID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectSecondaryCategoryFromID` (IN `secondaryID` INT)   BEGIN
    SELECT * FROM categoriasecondaria WHERE ID = secondaryID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectSecondaryFromPrimary` (IN `primaryID` INT)   BEGIN
    SELECT * FROM categoriasecondaria WHERE IDCategoriaPrimaria = primaryID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectTemplateTransactionFromID` (IN `templateID` INT)   BEGIN
    SELECT * FROM template_transazioni WHERE ID = templateID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectTransactionFromID` (IN `transactionID` INT)   BEGIN
    SELECT * FROM transazione WHERE ID = transactionID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `selectUserByEmail` (IN `userEmail` VARCHAR(255))   BEGIN
    SELECT * FROM Profili WHERE Email = userEmail;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateBudget` (IN `p_NomeBudget` VARCHAR(255), IN `p_ImportoMax` DECIMAL(10,2), IN `p_DataInizio` DATE, IN `p_DataFine` DATE, IN `p_IDPrimaryCategory` INT, IN `p_ID` INT)   BEGIN
    UPDATE budgetmax
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateConto` (IN `p_NomeConto` VARCHAR(255), IN `p_Saldo` DECIMAL(10,2), IN `p_ID` INT)   BEGIN
    UPDATE conto
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateCredito` (IN `p_ImportoCredito` DECIMAL(10,2), IN `p_NomeImporto` VARCHAR(255), IN `p_DataConcessione` DATE, IN `p_DataEstinsione` DATE, IN `p_Note` TEXT, IN `p_IDConto` INT, IN `p_IDCategoriaPrimaria` INT, IN `p_ID` INT)   BEGIN
    UPDATE credit
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateDebito` (IN `p_ImportoDebito` DECIMAL(10,2), IN `p_NomeImporto` VARCHAR(255), IN `p_DataConcessione` DATE, IN `p_DataEstinsione` DATE, IN `p_Note` TEXT, IN `p_IDConto` INT, IN `p_IDCategoriaPrimaria` INT, IN `p_ID` INT)   BEGIN
    UPDATE debit
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdatePrimaryCategory` (IN `p_NomeCategoria` VARCHAR(255), IN `p_DescrizioneCategoria` TEXT, IN `p_ID` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateRisparmio` (IN `p_ImportoRisparmiato` DECIMAL(10,2), IN `p_DataInizio` DATE, IN `p_DataFine` DATE, IN `p_IDConto` INT, IN `p_ID` INT)   BEGIN
    UPDATE risparmi
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateSecondaryCategory` (IN `p_NomeCategoria` VARCHAR(255), IN `p_DescrizioneCategoria` TEXT, IN `p_IDCategoriaPrimaria` INT, IN `p_ID` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateTemplateTransaction` (IN `p_NomeTemplate` VARCHAR(255), IN `p_Is_Expense` BOOLEAN, IN `p_Importo` DECIMAL(10,2), IN `p_IDConto` INT, IN `p_IDCategoriaPrimaria` INT, IN `p_IDCategoriaSecondaria` INT, IN `p_Descrizione` TEXT, IN `p_ID` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateTransaction` (IN `p_Is_Expense` BOOLEAN, IN `p_Importo` DECIMAL(10,2), IN `p_IDConto` INT, IN `p_DataTransazione` DATE, IN `p_IDCategoriaPrimaria` INT, IN `p_IDCategoriaSecondaria` INT, IN `p_ID` INT)   BEGIN
    UPDATE transazione
...
DELIMITER $$
CREATE TRIGGER `before_budget_insert_check` BEFORE INSERT ON `budgetmax` FOR EACH ROW BEGIN
    ...
    IF TotalSpent IS NOT NULL AND TotalSpent > NEW.ImportoMax THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Il budget inserito è già stato superato.';
    END IF;
END
$$
DELIMITER ;
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `create_transaction_on_credit_insert` AFTER INSERT ON `credit` FOR EACH ROW BEGIN
INSERT INTO
  transazione (
    Is_Expense,
    Importo,
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `create_transaction_on_debit_insert` AFTER INSERT ON `debit` FOR EACH ROW BEGIN
INSERT INTO
  transazione (
    Is_Expense,
    Importo,
...
ALTER TABLE profili_categoriaprimaria
  ...
  ADD CONSTRAINT fk_profili_categoriaprimaria_profilo FOREIGN KEY (IDProfilo) REFERENCES profili (ID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE risparmi
  ADD CONSTRAINT fk_risparmi_categoriaprimaria FOREIGN KEY (IDCategoriaPrimaria) REFERENCES categoriaprimaria (ID) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT risparmi_conto_fk FOREIGN KEY (IDConto) REFERENCES conto (ID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE template_transazioni
  ADD CONSTRAINT fk_template_transazioni_primaria FOREIGN KEY (IDCategoriaPrimaria) REFERENCES categoriaprimaria (ID) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT fk_template_transazioni_primaria_new FOREIGN KEY (IDCategoriaPrimaria) REFERENCES categoriaprimaria (ID) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT fk_template_transazioni_secondaria FOREIGN KEY (IDCategoriaSecondaria) REFERENCES categoriasecondaria (ID) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT fk_template_transazioni_secondaria_new FOREIGN KEY (IDCategoriaSecondaria) REFERENCES categoriasecondaria (ID) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT template_transazioni_conto_fk FOREIGN KEY (IDConto) REFERENCES conto (ID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE transazione
  ADD CONSTRAINT fk_transazione_primaria FOREIGN KEY (IDCategoriaPrimaria) REFERENCES categoriaprimaria (ID) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT fk_transazione_secondaria FOREIGN KEY (IDCategoriaSecondaria) REFERENCES categoriasecondaria (ID) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT transazione_conto_fk FOREIGN KEY (IDConto) REFERENCES conto (ID) ON DELETE CASCADE ON UPDATE CASCADE;

DELIMITER $$
CREATE DEFINER=root@localhost EVENT allocateSavingsEvent ON SCHEDULE EVERY 1 DAY STARTS '2024-05-15 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL AllocateSavingsDaily()$$

CREATE DEFINER=root@localhost EVENT check_debit_credit_expiry_event ON SCHEDULE EVERY 1 DAY STARTS '2024-05-08 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    DECLARE done INT DEFAULT FALSE;
